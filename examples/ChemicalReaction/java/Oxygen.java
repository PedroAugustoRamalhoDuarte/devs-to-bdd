...
public class Oxygen extends AtomicModelImpl implements PhaseBased,
    StateVariableBased {
    ...
    protected int MoleculesPresent = 4;
    ...
    // Input ports
    //ID:INP:0
    public final Port<Serializable> inReleaseOneMolecule =
        addInputPort("inReleaseOneMolecule", Serializable.class);
    ...
    // Output ports
    //ID:OUTP:0
    public final Port<IntEnt> outMoleculesOfOxygen =
        addOutputPort("outMoleculesOfOxygen", IntEnt.class);
    ...
    public Oxygen(String name) {
        this(name, null);
    }

    public Oxygen(String name, Simulator simulator) {
    ...
    public static void main(String[] args) {
        ...
        Oxygen model = new Oxygen();
        model.options = options;

        if (options.isDisableViewer()) { // Command line output only
            Simulation sim =
                new SimulationImpl("Oxygen Simulation", model, options);
    ...
    protected static File getModelsDirectory() {
        ...
        File dir;
        try {
            dirUri = Oxygen.class.getResource(".").toURI();
            dir = new File(dirUri);
        } catch (URISyntaxException e) {
            e.printStackTrace();
            throw new RuntimeException(
                "Could not find Models directory. Invalid model URL: " +
                Oxygen.class.getResource(".").toString());
        }
