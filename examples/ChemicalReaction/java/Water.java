...
DNL
platform:/resource/ChemicalReactionExample/src/Models/examples.ChemicalReaction.dnl/Water.examples.ChemicalReaction.dnl
-675328726
 Do not remove or modify this comment!  It is required for file identification! */
...
public class Water extends AtomicModelImpl implements PhaseBased,
    StateVariableBased {
    ...
    protected int MoleculesPresent = 0;
    ...
    // Input ports
    //ID:INP:0
    public final Port<Serializable> inAcceptOneMolecule =
        addInputPort("inAcceptOneMolecule", Serializable.class);
    ...
    // Output ports
    //ID:OUTP:0
    public final Port<IntEnt> outMoleculesOfWater =
        addOutputPort("outMoleculesOfWater", IntEnt.class);
    ...
    public Water(String name, Simulator simulator) {
    ...
    public static void main(String[] args) {
        ...
        Water model = new Water();
        model.options = options;

        if (options.isDisableViewer()) { // Command line output only
            Simulation sim =
                new SimulationImpl("Water Simulation", model, options);
    ...
    protected static File getModelsDirectory() {
        ...
        File dir;
        try {
            dirUri = Water.class.getResource(".").toURI();
            dir = new File(dirUri);
        } catch (URISyntaxException e) {
            e.printStackTrace();
            throw new RuntimeException(
                "Could not find Models directory. Invalid model URL: " +
                Water.class.getResource(".").toString());
        }
